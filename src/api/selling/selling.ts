...
import { IGetSellingParams, ISelling } from './types';
...
class SellingApi extends Instance {
  constructor(config: INetworkConfig) {
    super(config);
  }

  getSellings = (params: IGetSellingParams): Promise<IResponse<ISelling[]>> =>
...
export const sellingApi = new SellingApi(config);
