...
//PRODUCER
export const Producer = lazy(() =>
  import('@/pages/Producer').then(({ Producer }) => ({ default: Producer })).catch(handleCatchChunkError));

// STOREHOUSE
export const Showroom = lazy(() =>
  import('@/pages/Showroom').then(({ Showroom }) => ({ default: Showroom })).catch(handleCatchChunkError));
